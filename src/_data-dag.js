...
import {addRow, delRow} from './row-ops'
import {wellIndex} from './well-index'
import {topoRank} from './topo-rank'
import {topoSort} from './topo-sort'
import {noop} from './noop'

export default function DataDAG() {
...
var DONE = DataDAG.DONE = 0, // completed, graph changed
		EXISTS = DataDAG.EXISTS = 1, // duplicate entry, no changes
		MISSING = DataDAG.MISSING = 2, // non existing entry, nothing deleted
		CYCLE = DataDAG.CYCLE = 3, // cycle detected, no changes
		LINKED = DataDAG.LINKED = 4 // edges must be deleted before nodes, no changes
